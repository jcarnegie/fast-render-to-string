...
var REACT_CLASS_PROPS_QUERY = "$.~.callee.property[?(@.type=='Identifier' && @.name=='createClass')].^.^.arguments.*.properties";
...
var findReactClassProps        = find(REACT_CLASS_PROPS_QUERY);
...
var componentFn = r.curry(function(componentParentDir, componentPath, componentName) {
    ...
    //mixins - react handles this first, we might want
    // to handle this first as well
    //TODO add mixin logic here
    //var mixinsArray = findMixinsArrayFn(ast)
    ...
    // other props in createClass
    var ignore = ["displayName", "render", "getInitialProps", "getInitialState"];
